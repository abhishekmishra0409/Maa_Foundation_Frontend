...
const Card = ({ imgSrc, cardTitle, cardDescription, link = "#" }) => {
  return (
    <div className="w-full sm:w-100% md:w-100% lg:w-100% xl:w-1/5 cursor-pointer hover:scale-[1.05] hover:translate-y-1 transition-transform duration-300 py-2 shadow-lg hover:shadow-xl rounded-lg">
      <div>
